...
function Compteur() {
  var nbWeek;
  var NbWeekURL = `http://62.210.53.84:3002/nodejs/gettotal?startdate=${dateSeptJour()}&enddate=${dateAujourdui()}`;
  var nbWeekDV;
  ...
  var nbTotal;
  var nbTotalURL = `http://62.210.53.84:3002/nodejs/gettotal?startdate=2010-01-01&enddate=${dateAujourdui()}`;
  var nbTotalDV;
